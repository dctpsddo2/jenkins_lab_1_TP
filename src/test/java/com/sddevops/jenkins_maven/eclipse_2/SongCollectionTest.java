 ...
 * 
 */
package com.sddevops.jenkins_maven.eclipse_2;
...
class SongCollectionTest {
	...
	void setUp() throws Exception {
		sc = new SongCollection(); //Capacity is size 20
	...
	void testGetSongs() {
		...
		//System.out.print("Size of testSc: "+testSc.size());
	...
	void testSortSongsByTitle() {
		...
		//Original value
//		s1 = new Song("001", "good 4 u", "Olivia Rodrigo", 3.59); - index 0
//		s2 = new Song("002", "Peaches", "Justin Bieber", 3.18); - index 1
//		s3 = new Song("003", "MONTERO", "Lil Nas", 2.3);		- index 2
//		s4 = new Song("004", "bad guy", "billie eilish", 3.14); - index 3
//		
		...
		//sorting by title would sort by CAPITAL letters first then non capital letters
	...
	void testSortSongsBySongLength() {
		...
		//sorting from largest song length to the smallest song length
